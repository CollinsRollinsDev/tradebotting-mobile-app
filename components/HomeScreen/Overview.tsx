...
export default function Overview() {
  ...
  const { btcData, ethData, bnbData }: any = useSelector(
        ...
        <View style={styles.bottom}>
          <View style={styles.bottomView}>
            ...
            <Text style={styles.item}>
              ${coin ? coin.current_price.toLocaleString() : "Fetching Data"}
            </Text>
          </View>
          <View style={styles.bottomView}>
            <Text style={styles.price}>24hr Percent Change:</Text>
            <Text style={styles.item}>
              {coin ? coin.price_change_percentage_24h.toFixed(2) : null} %
            </Text>
          </View>
          <View style={styles.bottomView}>
            <Text style={styles.price}>24hr Price Change:</Text>
            <Text style={styles.item}>
              $
